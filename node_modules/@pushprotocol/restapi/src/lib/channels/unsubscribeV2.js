...
const unsubscribeV2 = (options) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    ...
    try {
        ...
        const signature = yield (0, helpers_1.signTypedData)(signer, domainInformation, typeInformation, messageInformation, 'Unsubscribe');
        ...
        const res = yield axios_1.default.post(requestUrl, body);
...
//# sourceMappingURL=unsubscribeV2.js.map