...
class Video {
    ...
    request(options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { senderAddress, recipientAddress, chatId, onReceiveMessage = (message) => {
                console.log('received a meesage', message);
            }, retry = false, details, } = options || {};
            ...
            for (const recipientAddress of recipientAddresses) {
                try {
                    ...
                    this.peerInstances[recipientAddress].on('connect', () => {
                        ...
                        console.log('REQUEST - SENDING THE CONNECTED ADDRESSES', 'connectedAddresses', connectedAddresses);
                        this.peerInstances[recipientAddress].send(JSON.stringify({
                    ...
                    this.peerInstances[recipientAddress].on('data', (data) => {
                        ...
                        if ((0, isJSON_1.default)(data)) {
                            ...
                            if (parsedData.type === 'connectedAddresses') {
                                console.log('REQUEST - RECEIVING CONNECTED ADDRESSES', 'CONNECTED ADDRESSES', parsedData.value);
    ...
    acceptRequest(options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { signalData, senderAddress, recipientAddress, chatId, onReceiveMessage = (message) => {
                console.log('received a meesage', message);
            }, retry = false, details, } = options || {};
            try {
                ...
                this.peerInstances[recipientAddress].on('connect', () => {
                    ...
                    console.log('ACCEPT REQUEST - SENDING THE CONNECTED ADDRESSES', 'connectedAddresses', connectedAddresses);
                    this.peerInstances[recipientAddress].send(JSON.stringify({
                        type: 'connectedAddresses',
                        value: connectedAddresses,
                    }));
                ...
                this.peerInstances[recipientAddress].on('data', (data) => {
                    ...
                    if ((0, isJSON_1.default)(data)) {
                        const parsedData = JSON.parse(data);
                        if (parsedData.type === 'connectedAddresses') {
                            console.log('ACCEPT REQUEST - RECEIVING CONNECTED ADDRESSES', 'CONNECTED ADDRESSES', parsedData.value);
                            const receivedConnectedAddresses = parsedData.value;
                            const localConnectedAddresses = (0, getConnectedAddresses_1.default)({
                                incomingPeers: this.data.incoming,
                            });
    ...
    connect(options) {
        ...
        try {
            console.log('connect', 'options', options, 'default', this.data.incoming[0].address);
            if (!peerAddress) {
    ...
    disconnect(options) {
        ...
        try {
            console.log('DISCONNECT OPTIONS', options, 'default', this.data.incoming[0].address);
            ...
            const incomingIndex = peerAddress
                ? (0, getIncomingIndexFromAddress_1.default)(this.data.incoming, peerAddress)
                : 0;
            console.log('disconnect', 'options', options, 'status', (_a = this.data.incoming[incomingIndex]) === null || _a === void 0 ? void 0 : _a.status);
            if (this.data.incoming[incomingIndex].status === types_1.VideoCallStatus.CONNECTED) {
                (_b = this.peerInstances[peerAddress ? peerAddress : this.data.incoming[0].address]) === null || _b === void 0 ? void 0 : _b.send(JSON.stringify({ type: 'endCall', value: true, details }));
            ...
            (_d = this.peerInstances[peerAddress ? peerAddress : this.data.incoming[0].address]) === null || _d === void 0 ? void 0 : _d.destroy();
