...
;
const sendVideoCallNotification = ({ signer, chainId, pgpPrivateKey }, { recipientAddress, senderAddress, chatId, status, signalData = null, env = constants_1.default.ENV.PROD, callType = constants_2.VIDEO_CALL_TYPE.PUSH_VIDEO, callDetails }) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    try {
        const videoData = {
            recipientAddress,
            senderAddress,
