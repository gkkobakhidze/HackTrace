    ...
    constructor(signer, env, account) {
        ...
        this.send = (recipients, options) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const info = yield this.getChannelOrAliasInfo((_a = options.channel) !== null && _a !== void 0 ? _a : this.account);
                let settings = null;
                ...
                const lowLevelPayload = this.generateNotificationLowLevelPayload({
                    ...
                    options: options,
                    channel: (_b = options.channel) !== null && _b !== void 0 ? _b : this.account,
                    settings: settings,
                });
        ...
        this.create = (options) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const fees = ethers_1.ethers.utils.parseUnits(config.MIN_TOKEN_BALANCE[this.env].toString(), 18);
                if (fees.gt(balance)) {
                ...
                const identityBytes = ethers_1.ethers.utils.toUtf8Bytes(identity);
                // call contract
        ...
        this.verify = (channelToBeVerified) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!ethers_1.ethers.utils.isAddress(channelToBeVerified)) {
