    ...
    constructor(signer, env, account) {
        ...
        this.list = (spam = PushNotificationTypes_1.FeedType.INBOX, options) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { account = this.account
                ...
                : null, page = constants_1.default.PAGINATION.INITIAL_PAGE, limit = constants_1.default.PAGINATION.LIMIT, channels = [], raw = false, } = options || {};
            try {
                // guest mode and valid address check
                this.checkUserAddressExists(account);
                if (!(0, helpers_1.validateCAIP)(account)) {
                    throw new Error('Invalid CAIP');
                }
                const nonCaipAccount = account === null || account === void 0 ? void 0 : account.split(':')[(account === null || account === void 0 ? void 0 : account.split(':').length) - 1];
