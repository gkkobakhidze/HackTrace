...
const updateGroupCore = (options, pgpHelper) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const body = (0, helpers_2.updateGroupPayload)(groupName, convertedMembers, convertedAdmins, connectedUser.did, verificationProof, groupDescription, groupImage, scheduleAt, scheduleEnd, status, meta, rules);
