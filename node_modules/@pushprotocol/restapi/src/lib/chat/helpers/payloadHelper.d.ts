...
export declare const sendMessagePayload: (receiverAddress: string, senderCreatedUser: IConnectedUser, messageObj: MessageObj, messageContent: string, messageType: string, group: GroupDTO | null, env: ENV) => Promise<ISendMessagePayload>;
export declare const sendMessagePayloadCore: (receiverAddress: string, senderCreatedUser: IConnectedUser, messageObj: MessageObj | string, messageContent: string, messageType: string, group: GroupDTO | null, env: ENV, pgpHelper: IPGPHelper) => Promise<ISendMessagePayload>;
export declare const approveRequestPayload: (fromDID: string, toDID: string, status: 'Approved' | 'Reproved', sigType: string, signature: string) => IApproveRequestPayload;
...
export declare const updateGroupPayload: (groupName: string, members: Array<string>, admins: Array<string>, address: string, verificationProof: string, groupDescription?: string | null, groupImage?: string | null, scheduleAt?: Date | null, scheduleEnd?: Date | null, status?: ChatStatus | null, meta?: string | null, rules?: Rules | null) => IUpdateGroupRequestPayload;
