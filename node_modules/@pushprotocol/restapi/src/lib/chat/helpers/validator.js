...
exports.updateGroupRequestValidator = exports.validateScheduleDates = exports.createSpaceRequestValidator = exports.createGroupRequestValidator = void 0;
...
const createSpaceRequestValidator = (spaceName, spaceDescription, members, admins, contractAddressNFT, numberOfNFTs, contractAddressERC20, numberOfERC20) => {
    ...
    if (contractAddressNFT != null && (contractAddressNFT === null || contractAddressNFT === void 0 ? void 0 : contractAddressNFT.length) > 0 && !(0, helpers_1.isValidNFTCAIP10Address)(contractAddressNFT)) {
        throw new Error(`Invalid contractAddressNFT address!`);
    }
    if (numberOfNFTs != null && numberOfNFTs < 0) {
        throw new Error(`numberOfNFTs cannot be negative number`);
    }
    if (contractAddressERC20 != null && (contractAddressERC20 === null || contractAddressERC20 === void 0 ? void 0 : contractAddressERC20.length) > 0 && !(0, helpers_1.isValidNFTCAIP10Address)(contractAddressERC20)) {
        throw new Error(`Invalid contractAddressERC20 address!`);
    }
    if (numberOfERC20 != null && numberOfERC20 < 0) {
        throw new Error(`numberOfERC20 cannot be negative number`);
