...
import { ADDITIONAL_META_TYPE, IDENTITY_TYPE, NOTIFICATION_TYPE, SPACE_ACCEPT_REQUEST_TYPE, SPACE_DISCONNECT_TYPE, SPACE_INVITE_ROLES, SPACE_REQUEST_TYPE } from '../../lib/payloads/constants';
...
export declare enum GROUP_RULES_CATEGORY {
    PUSH = "PUSH",
    GUILD = "GUILD",
    ERC721 = "ERC721",
    ERC20 = "ERC20",
...
export declare enum GROUP_RULES_SUB_CATEGORY {
    DEFAULT = "DEFAULT",
    HOLDER = "holder",
    GET = "GET"
}
export declare enum GROUP_RULES_PERMISSION {
    ENTRY = "Entry",
    CHAT = "Chat"
}
export declare enum GROUP_INVITER_ROLE {
    ADMIN = "ADMIN",
    OWNER = "OWNER"
}
export type Data = {
