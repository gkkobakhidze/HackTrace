    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        switch (senderType) {
            case 0: {
                ...
                const signature = yield (0, helpers_1.signTypedData)(signer, domain, type, message, 'Data');
...
function getCAIPFormat(chainId, address) {
    // EVM based chains
    if ([1, 11155111, 42, 137, 80001, 56, 97, 10, 420, 1442, 1101, 421613, 42161].includes(chainId)) {
