...
class DataModifier {
    ...
    static buildChatGroupEventMetaAndRaw(incomingData, includeRaw) {
        ...
        const mapPendingMembersAdmins = (arr) => {
            return arr.map((item) => ({
                address: item.wallet,
                profile: {
                    image: item.image,
        ...
        const meta = {
            ...
            members: mapMembersAdmins(incomingData.members.filter((m) => !m.isAdmin)),
            admins: mapMembersAdmins(incomingData.members.filter((m) => m.isAdmin)),
            pending: {
                members: mapPendingMembersAdmins(incomingData.pendingMembers.filter((m) => !m.isAdmin)),
                admins: mapPendingMembersAdmins(incomingData.pendingMembers.filter((m) => m.isAdmin)),
            },
