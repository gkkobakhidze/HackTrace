...
const socket_1 = require("@pushprotocol/socket");
...
class PushStream extends events_1.EventEmitter {
    constructor(account, decryptedPgpPvtKey, signer, _listen, options, progressHook) {
        var _a;
        super();
        ...
        this.listen = _listen;
        this.chatInstance = new chat_1.Chat(this.account, this.decryptedPgpPvtKey, this.options.env, this.signer, this.progressHook);
    }
    static initialize(account, decryptedPgpPvtKey, signer, listen, env, progressHook, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const stream = new PushStream(accountToUse, decryptedPgpPvtKey, signer, listen, settings, progressHook);
            return stream;
        });
    }
    connect() {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (shouldInitializeChatSocket) {
                if (!this.pushChatSocket) {
                    ...
                    this.pushChatSocket = (0, socket_1.createSocketConnection)({
            ...
            if (shouldInitializeNotifSocket) {
                if (!this.pushNotificationSocket) {
                    ...
                    this.pushNotificationSocket = (0, socket_1.createSocketConnection)({
            ...
            if (this.pushChatSocket) {
                this.pushChatSocket.on(socket_1.EVENTS.CONNECT, () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    isChatSocketConnected = true;
                    checkAndEmitConnectEvent();
                    console.log(`Chat Socket Connected (ID: ${this.pushChatSocket.id})`);
                }));
                this.pushChatSocket.on(socket_1.EVENTS.DISCONNECT, () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    yield handleSocketDisconnection('chat');
                    //console.log(`Chat Socket Disconnected`);
                }));
                this.pushChatSocket.on(socket_1.EVENTS.CHAT_GROUPS, (data) => {
                    try {
                ...
                this.pushChatSocket.on(socket_1.EVENTS.CHAT_RECEIVED_MESSAGE, (data) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    try {
            ...
            if (this.pushNotificationSocket) {
                this.pushNotificationSocket.on(socket_1.EVENTS.CONNECT, () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    console.log(`Notification Socket Connected (ID: ${this.pushNotificationSocket.id})`);
                    isNotifSocketConnected = true;
                    checkAndEmitConnectEvent();
                }));
                this.pushNotificationSocket.on(socket_1.EVENTS.DISCONNECT, () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    yield handleSocketDisconnection('notif');
                    //console.log(`Notification Socket Disconnected`);
                }));
                this.pushNotificationSocket.on(socket_1.EVENTS.USER_FEEDS, (data) => {
                    try {
                ...
                this.pushNotificationSocket.on(socket_1.EVENTS.USER_SPAM_FEEDS, (data) => {
                    try {
